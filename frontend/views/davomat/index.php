...
/** @var app\models\DavomatSearch $searchModel */
...
<div class="davomat-index">
    ...
    <div class="row ">
        ...
        <div class="col-md-1">
            <button type="button" style="width: 320px" class="btn btn-primary" data-bs-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Kameraga qarang</h5>
                ...
                <div class="modal-body">
                    ...
                    <center>
                        ...
                        <input type=button value="Ishga keldim" onClick="take_snapshot_in()">
                        <input type=button value="Ishdan chiqdim" onClick="take_snapshot_out()">
                        <div id="results"></div>
                                ...
                                var Webcam = {
                                    ...
                                    detectFlash: function () {
                                        var t = "Shockwave Flash", a = "ShockwaveFlash.ShockwaveFlash",
                                            i = "application/x-shockwave-flash", s = e, r = navigator, o = false;
...
// San'at va vaqtning istagan formatda chiqarish
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "/davomat/saveimagein", // Yii2-ni controller va action nomi
                                        data: {image: data_uri, filename: filename},
                                        success: function (response) {
                                            alert("Qabul qilindi " + response);
                                        },
                                        error: function () {
...
// San'at va vaqtning istagan formatda chiqarish
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "/davomat/saveimageout", // Yii2-ni controller va action nomi
                                        data: {image: data_uri, filename: filename},
                                        success: function (response) {
                                            alert("Qabul qilindi ");// + response);
                                        },
...
//            'employee_id',
            [
                ...
                'filter' => ArrayHelper::map(User::find()->all(), 'id', 'fio'),
                'value' => function ($model) {
                    $employee_id = $model->employee_id;
                    $fio = User::findOne($employee_id);
                    return $fio->fio;
                },
            ],
//            'photo',
            [
                ...
                'format' => 'raw',
                'value' => function ($model) {
                    return Html::img($model->photo, ['width' => '120']);
                },
            ],
            [
                'attribute' => 'action',
                ...
                'value' => function ($model) {
                        if ($model->action == 1)
                            $a = '<i class="bi bi-bank"></i>';
                        if ($model->action == 2)
                            $a = '<i class="bi bi-arrow-up-right-circle-fill"></i>';
                    return $a;
                },
            ],
//            'action',
...
//                'value' => function ($model) {
//                    return Yii::$app->formatter->asDatetime($model->time, 'php:Y-m-d H:i:s');
//                },
//
//            ],
